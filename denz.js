		...
		message: {
			"productMessage": {
				"product": {
					...
					"title": `GZ BOTZ ${tampilUcapan} ${pushname}`, //Kasih namalu 
...
const daftar3 = [{buttonId: `verify`,buttonText: {displayText: `📋DAFTAR BIAR MASUK DATA `,},type: 1,},]
...
sendButMessage(from, `${JSON.stringify(me, null, 2)}`, "*_© Gz X Pares_*", [{buttonId: 'igm', buttonText: {displayText: 'Instagram'}, type: 1},{buttonId: 'ytm', buttonText: {displayText: 'YouTube'}, type: 1}], {quoted:ftrol, contextInfo: { forwardingScore: 508, isForwarded: true}})
}
if(isButton == 'igm'){
reply('gk punya om°-°')
}
if(isButton == 'ytm'){
reply('https://youtube.com/channel/UCwEk1G7HDuIiQ4xU7khax6g')
}
...
Hai Aku XNXX BOTZ whatsapp Butuh Apa Kak? 
Seperti Sticker Atau lagu Atau lainnya kak


Jika Button Tidak Muncul Ketik .allmenu`
menu =`XNXX BOTZ🌀`
gbutsan = [
{buttonId:`allmenu`,buttonText:{displayText:'📋SHOW MENU BOT'},type:1},
...
"mediaType": "2",
"mediaUrl": "https://youtube.com/channel/UCwEk1G7HDuIiQ4xU7khax6g",
"thumbnail": pporigi,
...
│
└───「 \`\`\`${NamaBot}\`\`\` 」`
sendButLocation(from, `${menu}`, "*_©XNXX BOTZ_*☕", {jpegThumbnail:ofrply,name:""}, [{buttonId:`command`,buttonText:{displayText:'📋LIST MENU BOT📋'},type:1},{buttonId:`owner`,buttonText:{displayText:'🔥DEVELOPER BOT🔥'},type:1},{buttonId:`script`,buttonText:{displayText:'📥SOURCE CODE📥'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
}
break
case 'allmenu': 
  if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
stod = `${sender}`
       stst = await denz.getStatus(`${sender.split('@')[0]}@c.us`)
       nama = 'XNXX BOTZ  W H A T S A P P🌀'
       ownerJid = "6285798411437@s.whatsapp.net"
				stst = stst.status == 401 ? '' : stst.status
			num = await fetchJson(`https://api.telnyx.com/anonymous/v2/number_lookup/${senderNumber}`, {method: 'get'})
menunya = `╭─❒ 「 Bot Info 」 ❒
├ _Creator : @${dtod.split('@')[0]}_
...
{buttonId:`script`,buttonText:{displayText:'🔖SCRIPT/sourcecode'},type:1}
]
mhan = await denz.prepareMessage(from, pporigi, image, {thumbnail: pporigi})
const btnBngsat = {
imageMessage: mhan.message.imageMessage,
contentText: `${menunya}`,
footerText: `XNXX BOTZ W H A T S A P P`,
buttons: gbutsan,
headerType: 4
}
...
imageMessage: mhan.message.imageMessage,
contentText:`${jancok}`,
footerText:'Terimakasih Sudah Mendaftar\n*_©XNXX BOTZ  W H A T S A P P_*', 
buttons: gbutsan,
headerType: 4
}
denz.sendMessage(from, sendBtnVeryy, MessageType.buttonsMessage, {quoted:ftrol, contextInfo: { mentionedJid: [sender]}})
	         console.log(color('[REGISTER BOT XNXX]'), color(time, 'yellow'), 'Serial:', color(serialUser, 'cyan'), 'in', color(sender || groupName))
	    // console.log(e)
        break
case 'command':
  if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
 ...
 footerText: '*_© XNXX BOTZ  W H A T S A P P_*',
...
footerText: '*_©Ɠ̷ͥ  ɀ̷̴ͫ  B̷̴ͥ  Ó̷̴ͣ꙰  Ť̷̴ͫ  ɀ̷̴̒  W H A T S A P P_*',
buttons: gbutsan,
headerType: 4
}
...
client.browserDescription = ['GZ X DENPA','Desktop','3.0']
...
break
		...
		anu =`╭─❒ SCRIPT
│◦➛Base : Denis Putra
│◦➛Recode : *_©RAIHAN GANZZ_*
│--->Recode ke 2 : *GZ BOTZ*
└──────[ GITHUB ]──────❒
  │◦➛Script Ory :
  │◦➛https:-
  │◦➛Script Recode : 
  │◦➛https://instagram.com/raihanabdarouf
  └──────────────────❒`
 buttons = [
